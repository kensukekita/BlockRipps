...
const string strMessageMagic = "BlockRipps Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlockRipps", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "do what you want cause a pirate is free you are a pirate";
        CTransaction txNew;
        txNew.nTime = 1508815578;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 2217145 : 2217145;
        ...
        assert(block.hashMerkleRoot == uint256("0x458648ea5fc962256bdeef3dd75d44d2a48ba0a51a2f475bc527796999458cc4"));
